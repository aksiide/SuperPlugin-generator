...
class %module_name%_Block_Contoh extends Zikula_Controller_AbstractBlock {

	public function init(){
		// Security
		SecurityUtil::registerPermissionSchema('%module_name%:ContohBlock:', 'Block title::');
  }

  public function info()   {
		return array('module'          => '%module_name%',
	...
	// security check
	$this->throwForbiddenUnless(SecurityUtil::checkPermission('%module_name%:ContohBlock:', "$blockinfo[title]::", ACCESS_READ), LogUtil::getErrorMsgPermission());
