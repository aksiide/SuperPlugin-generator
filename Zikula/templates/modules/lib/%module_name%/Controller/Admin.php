 ...
 */
class %module_name%_Controller_Admin extends Zikula_AbstractController{
	/**
	...
	public function main()	{
		...
		$this->throwForbiddenUnless(SecurityUtil::checkPermission('%module_name%::', '::', ACCESS_EDIT), LogUtil::getErrorMsgPermission());

		// example : library call
    $args = array();
		%module_name%_Util::NamaFungsi( $args);
		
		$view = FormUtil::newForm('%module_name%', $this);
		return $view->execute('admin/main.tpl', new %module_name%_Form_Handler_Admin_Main($args));
