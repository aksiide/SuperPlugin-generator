...
function %module_name%_tables(){
  global $Aksi;
  $tables = array();

	// Full table definition
	$tables['%module_id%_contohtable'] = '%module_id%_contohtable';
	$tables['%module_id%_contohtable_column'] = array(
			'id'               => 'id',
			'name'             => 'name',
	...
	$tables['%module_id%_contohtable_column_def'] = array(
